...
| Precompiled Mac mod | [Download v0.1.0-alpha ZIP](https://github.com/Jtshieh/STS2-Tools/releases/download/v0.1.0-alpha/Sts2Recorder-macos-arm64-v0.1.0-alpha.zip) to record gameplay. Includes the recorder DLL, mod manifest, and license files. |
