...
| Precompiled Mac mod | [Download recorder ZIP](https://github.com/Jtshieh/STS2-Tools/releases/download/v0.1.3-alpha/Sts2Recorder-macos-arm64-v0.1.3-alpha.zip) to record gameplay. Includes the recorder DLL, mod manifest, and license files. |
...
Download the [Mac mod ZIP](https://github.com/Jtshieh/STS2-Tools/releases/download/v0.1.3-alpha/Sts2Recorder-macos-arm64-v0.1.3-alpha.zip), place `Sts2Recorder.dll` and `Sts2Recorder.json` in `SlayTheSpire2.app/Contents/MacOS/mods/`, and launch the game. The main menu displays `RECORDER READY` and the session's log directory.
